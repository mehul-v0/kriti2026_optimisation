...
export default function Sidebar() {
  ...
  return (
    ...
    >
      ...
      <div className="relative bg-dark-800/80 backdrop-blur-xl rounded-2xl border border-gray/10 shadow-2xl shadow-black/40 px-3 py-3 flex items-center overflow-hidden">
        <div
      ...
      <div className="flex-1 flex flex-col bg-dark-800/80 backdrop-blur-xl rounded-2xl border border-gray/10 shadow-2xl shadow-black/40 overflow-hidden">

...
int main(int argc, char* argv[]) {
    ...
    // Override metadata weights from config
    meta.cost_weight = g_config.cost_weight;
    meta.time_weight = g_config.time_weight;
    ...
    if (best_sol.hard_violations < 999999) {
        ...
        json out = OutputFormatter::to_json(best_sol);
